...
def img_boundingbox_data_constructor(mat_file):
    ...
    for j in range(f['/digitStruct/bbox'].shape[0]):
        ...
        for index, row in bbox_df.iterrows():
            ...
            image = cv2.imread('/home/apple/lee/cvHw2/darknet/build/darknet/x64/data/obj/' + img_name)
...
darknet_data_path = '/home/apple/lee/cvHw2/darknet/build/darknet/x64/data/'
...
def construct_for_darknet(img_folder, mat_file_name):
    ...
    for index, row in bbox_df.iterrows():
        ...
        image = cv2.imread('/home/apple/lee/cvHw2/darknet/build/darknet/x64/data/obj/' + img_name)
        height, width, _ = image.shape
        with open(darknet_data_path + 'obj/' + img_name.split('.')[0] + '.txt', 'a') as ff:
            ff.write(
